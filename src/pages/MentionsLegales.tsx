...
const MentionsLegales = () => {
  useEffect(() => {
    document.title = "Mentions Légales - Ferme Solaire";
  }, []);
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="bg-surface p-6 rounded-lg">
                <p><strong>Ferme Solaire</strong></p>
                ...
                <p>Téléphone : 04 12 28 02 41</p>
                <p>Email : contact@fermesolaire.fr</p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-display mb-4">Directeur de la publication</h2>
              <p>Le directeur de la publication du site www.fermesolaire.fr est le représentant légal de la société Ferme Solaire.</p>
            </section>

            <section>
              <h2 className="text-2xl font-display mb-4">Hébergement</h2>
              <div className="bg-surface p-6 rounded-lg">
                <p>Le site www.fermesolaire.fr est hébergé par :</p>
            ...
            <section>
              ...
              <p>
                L'ensemble du contenu du site www.fermesolaire.fr (textes, images, vidéos, etc.) est protégé par le droit d'auteur. 
                Toute reproduction, même partielle, est interdite sans autorisation préalable écrite de Ferme Solaire.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                Pour exercer ces droits, vous pouvez nous contacter à l'adresse : contact@fermesolaire.fr ou par courrier 
            ...
            <section>
              ...
              <p>
                Le site www.fermesolaire.fr utilise des cookies pour améliorer votre expérience de navigation et réaliser 
            ...
            <section>
              ...
              <p>
                Ferme Solaire s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur le site, 
                mais ne peut garantir leur exhaustivité ou leur absence d'erreur.
              </p>
              <p>
                L'utilisateur utilise les informations du site sous sa propre responsabilité. Ferme Solaire ne saurait 
            ...
            <section>
              ...
              <p>
                Le site peut contenir des liens vers d'autres sites web. Ferme Solaire n'exerce aucun contrôle sur ces sites 
            ...
            <section>
              ...
              <div className="bg-surface p-6 rounded-lg">
                ...
                <ul className="list-disc list-inside mt-4 space-y-2">
                  <li>Par téléphone : 04 12 28 02 41</li>
                  <li>Par email : contact@fermesolaire.fr</li>
                  <li>Par courrier : Ferme Solaire, Aix-en-Provence, France</li>
                </ul>
              </div>
            </section>
